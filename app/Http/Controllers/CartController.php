...
{
    // agar function pada controller ini memerlukan login terlebih dahulu /atau bisa menggunakan route group di routes
    ...
    public function add_to_cart(Product $product, Request $request)
    {
        ...
        // deklarasi untuk pengecekan product id apakah sudah ada atau belum
